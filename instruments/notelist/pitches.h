...
// range from one octave to nine octave : 12(min) ~ 119(max)
typedef enum {
    hC1 = 12 , hCS1, hD1 , hDS1, hE1 , hF1 , 
    hFS1, hG1 , hGS1, hA1 , hAS1, hB1 ,
    hC2 , hCS2, hD2 , hDS2, hE2 , hF2 , 
    hFS2, hG2 , hGS2, hA2 , hAS2, hB2 ,
    hC3 , hCS3, hD3 , hDS3, hE3 , hF3 , 
    hFS3, hG3 , hGS3, hA3 , hAS3, hB3 , 
    hC4 , hCS4, hD4 , hDS4, hE4 , hF4 , 
    hFS4, hG4 , hGS4, hA4 , hAS4, hB4 ,
    hC5 , hCS5, hD5 , hDS5, hE5 , hF5 ,
    hFS5, hG5 , hGS5, hA5 , hAS5, hB5 , 
    hC6 , hCS6, hD6 , hDS6, hE6 , hF6 ,
    hFS6, hG6 , hGS6, hA6 , hAS6, hB6 ,
    hC7 , hCS7, hD7 , hDS7, hE7 , hF7 , 
    hFS7, hG7 , hGS7, hA7 , hAS7, hB7 ,
    hC8 , hCS8, hD8 , hDS8, hE8 , hF8 ,
    hFS8, hG8 , hGS8, hA8 , hAS8, hB8 ,
    hC9 , hCS9, hD9 , hDS9, hE9 , hF9 ,
    hFS9, hG9 , hGS9, hA9 , hAS9, hB9 

} hNotePitches;
static hNotePitches pitches;
